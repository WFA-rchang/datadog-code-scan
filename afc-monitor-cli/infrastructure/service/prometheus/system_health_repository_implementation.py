    ...
    def get_system_health(
        ...
        for system in system_names:
            if system in deployments:
                ...
                # special process for staging-env namespace
                if env == "staging" or env == "hotfix":
                    namespace = f"{deployments[system]['namespace']}-{env}"
                else:
            ...
            with ThreadPoolExecutor() as executor:
                for label in labels:
                    future = executor.submit(
                        self.prometheus_connect.get_current_metric_value,
